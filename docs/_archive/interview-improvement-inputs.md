...
> **Archived 2026-07-30.** Dated findings + prompt-tuning log (P1–P7) from the
> 2026-07-06→07-13 eval sweeps of the voice interviewer. Applied fixes now live in
> `app/_lib/student-interview.ts`, `VoiceInterview.tsx`, and
> `scripts/setup-eleven-agent.mjs`; the harness that produced these findings is
> documented as a living tool at
> [`docs/development/voice-interview-testing.md`](../development/voice-interview-testing.md);
> the shipped interviewer surface is at
> [`docs/features/interviews/README.md`](../features/interviews/README.md). Kept as
> the historical record of what was tried and measured.
