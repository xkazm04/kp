> Archived 2026-07-30. Dated evidence from the 2026-06-19 L1 UAT sweep; 11 of
> 12 ranked items shipped (checked below). The one still open — **M4, outreach
> draft/preview before send** — was re-verified against the live code
> (`app/_lib/automation-run.ts`, `app/_lib/outreach-halt.ts`) and carried
> forward; see the doc-restructure report for detail.
