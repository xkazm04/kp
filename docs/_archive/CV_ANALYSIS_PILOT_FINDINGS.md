...
> **Archived 2026-07-30.** Dated pilot report. The still-true calibration
> facts (salary-anchor fix, aspiration disambiguation, remaining
> job-band-anchoring gap) are folded into `docs/features/candidates/README.md`
> under "CV analysis quality". Kept here for the full pilot methodology and
