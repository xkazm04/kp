...
> **Archived 2026-07-30.** Fully folded into `docs/features/matching/README.md`
> §4 (formula, gate, and worked examples verified against
> `pipeline/jobfit/jobs.py` and the golden tests in `test_jobs.py`). Kept here
> for the complete worked-example table.
