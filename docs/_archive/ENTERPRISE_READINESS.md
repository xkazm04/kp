> **Archived 2026-07-30.** Superseded by `docs/product/enterprise-readiness.md`
> (same roadmap, statuses re-verified against code — several items marked open
> here are now DONE). Kept here as the original 2026-07-05 scan snapshot.
...
`app/globals.css` (`docs/design/README.md`), with a recipe layer (`recipes.ts`). Comms
