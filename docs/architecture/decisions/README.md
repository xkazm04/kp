...
- add a second funnel, a second candidate board, or a per-population score → [0009](0009-need-role-slate-one-board.md)
...
| [0009](0009-need-role-slate-one-board.md) | A need composes a role; the role's slate is one board and one rubric | proposed | 2026-09-14 |
