...
This project is organized into **191 contexts** across **27 groups**. The full machine-readable map lives in `context-map.json` at the project root — read it at task start to scope your edits to the relevant context's files.
...
- **Candidate Matching & Ranking** _(domain: feature · 5 contexts)_
...
- **Interviews & Assessments** _(domain: feature · 3 contexts)_
...
- **Candidate Intelligence** _(domain: feature · 5 contexts)_
- **Developer Assessment** _(domain: feature · 14 contexts)_
- **Voice Interview** _(domain: feature · 7 contexts)_
...
- **Design System & Shared UI** _(domain: — · 6 contexts)_
