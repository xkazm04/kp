...
This project is organized into **161 contexts** across **17 groups**, covering **3019 source and test files**. The full machine-readable map lives in `context-map.json` at the project root — read it at task start to scope your edits to the relevant context’s files.
