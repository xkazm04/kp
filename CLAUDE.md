...
This project is organized into **210 contexts** across **27 groups**. The full machine-readable map lives in `context-map.json` at the project root — read it at task start to scope your edits to the relevant context's files.
...
- **CV Analysis & Scoring** _(domain: feature · 12 contexts)_
- **Candidate Matching & Ranking** _(domain: feature · 6 contexts)_
- **Hiring Pipeline** _(domain: feature · 8 contexts)_
- **Hiring Decisions** _(domain: feature · 8 contexts)_
- **Interview Scheduling** _(domain: feature · 5 contexts)_
- **Candidate Channels** _(domain: feature · 2 contexts)_
- **Employee Onboarding** _(domain: feature · 0 contexts)_
- **Talent Pipeline** _(domain: feature · 0 contexts)_
- **Job & JD Management** _(domain: feature · 18 contexts)_
- **Interviews & Assessments** _(domain: feature · 4 contexts)_
- **Candidate Engagement** _(domain: feature · 8 contexts)_
- **Analytics & Reporting** _(domain: feature · 8 contexts)_
- **Platform Administration** _(domain: infrastructure · 16 contexts)_
- **ATS Integration** _(domain: integration · 2 contexts)_
- **Authentication & Access Control** _(domain: infrastructure · 3 contexts)_
- **Billing & Subscriptions** _(domain: feature · 3 contexts)_
- **Data Access Layer** _(domain: data · 7 contexts)_
- **AI & LLM Infrastructure** _(domain: infrastructure · 16 contexts)_
- **Candidate Intelligence** _(domain: feature · 13 contexts)_
- **Developer Assessment** _(domain: feature · 18 contexts)_
- **Voice Interview** _(domain: feature · 9 contexts)_
- **Communications & Scheduling** _(domain: feature · 2 contexts)_
- **Compliance & Privacy** _(domain: infrastructure · 2 contexts)_
- **Organization Management** _(domain: feature · 3 contexts)_
- **Shared Utilities** _(domain: shared · 11 contexts)_
- **Design System & Shared UI** _(domain: — · 7 contexts)_
- **Workspace Shell & Onboarding** _(domain: — · 19 contexts)_
