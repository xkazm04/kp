...
import { getPosting } from "@/app/_lib/db/jobseeker-postings";
...
export default async function PostingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <PostingDetail view={postingDetailView(posting, sourceLabel, attribution)} salaryFloor={profile?.preferences.salaryFloor ?? null} profileId={profile?.id ?? null} />;
}
