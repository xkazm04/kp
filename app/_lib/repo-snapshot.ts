...
// The ref grammar lives on its own import-free leaf (repo-ref.ts) so client code can use
// it without this transport; re-exported here for the server callers that import it.
