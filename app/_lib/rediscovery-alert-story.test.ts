...
// project import.
//
// It used to be a hand-rolled `os.tmpdir()/kp-rediscovery-alert-story-${process.pid}.sqlite`.
...
// and inherits its committed alert rows (see 7c63692, the billing-suite flake). unit-db.ts is the
