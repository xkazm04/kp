...
const ALLOWED = new Map<string, string>([
  ...
  ["channels/webhooks/[token]/route.ts", "slice 2 candidate — ungated when this ratchet landed; not yet judged"],
  ["channels/webhooks/route.ts", "slice 2 candidate — ungated when this ratchet landed; not yet judged"],
  ...
  ["comms/relay/test/route.ts", "slice 2 candidate — ungated when this ratchet landed; not yet judged"],
  ...
  ["devcase/control/route.ts", "slice 2 candidate — ungated when this ratchet landed; not yet judged"],
  ...
  ["devcase/lifecycle/[id]/approve/route.ts", "slice 2 candidate — ungated when this ratchet landed; not yet judged"],
  ...
  ["devcase/outcomes/route.ts", "slice 2 candidate — ungated when this ratchet landed; not yet judged"],
