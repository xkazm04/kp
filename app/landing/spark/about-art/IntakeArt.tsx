  ...
  return (
    <div className="mx-auto w-full max-w-lg text-center">
      <div className="flex flex-wrap justify-center gap-2">
        {CHANNELS.map((c, i) => (
          <motion.span
            ...
            animate={reduceMotion ? { opacity: 1, x: 0, rotate: i % 2 ? 1.5 : -1.5 } : undefined}
            viewport={ENTER}
            transition={reduceMotion ? { duration: 0 } : { delay: 0.1 + i * 0.09, type: "spring", bounce: 0.4 }}
      ...
      <motion.div
        ...
        animate={reduceMotion ? { opacity: 1, scaleY: 1 } : undefined}
        viewport={ENTER}
        transition={reduceMotion ? { duration: 0 } : { delay: 0.6, duration: 0.3 }}
      ...
      <motion.div
        ...
        animate={reduceMotion ? { opacity: 1, scale: 1, y: 0 } : undefined}
        viewport={ENTER}
        transition={reduceMotion ? { duration: 0 } : { delay: 0.8, type: "spring", bounce: 0.5 }}
      ...
      >
        ...
        <motion.span
          ...
          animate={reduceMotion ? { opacity: 1, scale: 1, rotate: -6 } : undefined}
          viewport={ENTER}
          transition={reduceMotion ? { duration: 0 } : { delay: 1.05, type: "spring", bounce: 0.5 }}
