 ...
 *   4. `Esc` exits.
 *
 * MOUNTING: nothing imports this module statically. `DevInspector.tsx` — the
 * stub the root layout imports — reaches it through a `process.env.NODE_ENV`-
 * guarded dynamic `import()`, so a production browser never fetches this chunk.
 * The header of that file carries the measurement that forced the split.
 *
 * Without `dev:inspect` there are no `data-loc` attributes and the HUD says how
