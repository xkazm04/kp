/**
 * The five traced step glyphs, keyed by StepKey.
 *
 ...
 *
 * The art is one /motionize sheet traced per tile, so the five belong to a single
...
import { STEP_TEAM_GLYPH } from "@/app/_components/glyph/glyphs/stepTeamGlyph";
