...
export const SIM_CHAPTERS: readonly SimChapter[] = [
  // The JD builder left the library page for the Job-intake tab; the jd* prefill
  // this chapter carries is also what makes that tab open on Generate rather than
  // the intake dialog (jdsIntakeTabEntry.ts).
  { id: "design", tab: "intake", target: '[data-sim="jd-builder"]', readMs: 2200 },
