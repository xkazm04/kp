...
const ROOT = new URL("../../../../", import.meta.url).href; // app/features/tools/profile/ -> repo root
registerHooks({
...
const { fieldTargetForMissing, fieldTargetForCheck, FIELD_DOM_ID } = await import("./profileCompletenessFields.ts");
