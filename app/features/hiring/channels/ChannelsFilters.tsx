...
// off a FIXED-positioned anchor (ChannelsFilterMenu) so it escapes the table's
// overflow clip, and close on scroll / resize / Escape / backdrop. No third-party
// combobox in the repo, so this is the shared building block for both the comms
// table and the webhook forms.
