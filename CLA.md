...
> project, this maintainer or this jurisdiction. Do not rely on it as legal
> advice, and do not treat contributions as covered until this notice is removed.

## Why this exists

KandiDate is released under **AGPL-3.0-only**. The AGPL governs what *you* may do
