# Challenge scout brief — /scan-sweep 3.4.0 `--challenge`, kp, 2026-09-22
...
4. Never re-propose. Collect titles already on the books for this context:
   ...
   `.personas/backlog-digest.json`. A card restating one of those is void. You
...
6. Write your result to
   `.claude/scan-history/challenge-2026-09-22/cards/<ctx>.json` — a JSON array of
